...
{
    public class IPhoneUnitTests : TestsBase
    {
        public IPhoneUnitTests(ITestOutputHelper output, bool enableRealTimeLogging = false) : base(output, enableRealTimeLogging)
        {
        }

        [Trait(LpTraits.Keys.Category, LpTraits.Unit.MobileSafari)]
        [SkippableTheory]
        ...
        [Trait(LpTraits.Keys.Category, LpTraits.Unit.SwitchLpInstance)]
        [SkippableTheory]
        [InlineData(TestConfiguration.iPhone_Safari_SNIS_UNSI)]
