...
namespace LampsPlus.RegressionTests.Common.Shipping.T7519_T7520_VerifyFedExSimilarVerifiedAddressOption
{
    ...
    public class T7519_Windows_VerifyFedExSimilarVerifiedAddressOption : T7519_DesktopBase
    {
        public T7519_Windows_VerifyFedExSimilarVerifiedAddressOption(ITestOutputHelper output) : base(output) { }
    ...
    //[Collection(LpTraits.BatchGroup.Common.Shipping)]
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.Shipping)]
    public class T7519_Mac_VerifyFedExSimilarVerifiedAddressOption : T7519_DesktopBase
    {
        public T7519_Mac_VerifyFedExSimilarVerifiedAddressOption(ITestOutputHelper output) : base(output) { }
    ...
    //[Collection(LpTraits.BatchGroup.Common.Shipping)]
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.Shipping)]
    public class T7519_iPad_VerifyFedExSimilarVerifiedAddressOption : T7519_DesktopBase
    {
        public T7519_iPad_VerifyFedExSimilarVerifiedAddressOption(ITestOutputHelper output) : base(output) { }
    ...
    //[Collection(LpTraits.BatchGroup.Common.Shipping)]
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.Shipping)]
    public class T7519_TabletEmulator_VerifyFedExSimilarVerifiedAddressOption : T7519_DesktopBase
    {
        public T7519_TabletEmulator_VerifyFedExSimilarVerifiedAddressOption(ITestOutputHelper output) : base(output) { }
    ...
    /// Test Case Link: https://lampstrack.lampsplus.com:8443/secure/Tests.jspa#/testCase/LP-T7519
    /// </summary>
    [Trait(LpTraits.Keys.Category, LpTraits.Suite.Desktop)]
    [Trait(LpTraits.RequiredTestCaseTags.TaskId, "ACD-8686"), Trait(LpTraits.RequiredTestCaseTags.TId, "LP-T7519")]
    public abstract class T7519_DesktopBase : TestsBaseDesktop
    {
        protected T7519_DesktopBase(ITestOutputHelper output) : base(output) { }
