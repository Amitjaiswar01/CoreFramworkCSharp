...
namespace LampsPlus.RegressionTests.Common.Shipping.T165_T415_VerifyFedExMaintainEnteredAddressOption
{
    ...
    public class T415_iPhone_VerifyFedExMaintainEnteredAddressOption : T415_MobileBase
    {
        public T415_iPhone_VerifyFedExMaintainEnteredAddressOption(ITestOutputHelper output) : base(output) { }
    ...
    public class T415_Emulator_VerifyFedExMaintainEnteredAddressOption : T415_MobileBase
    {
        public T415_Emulator_VerifyFedExMaintainEnteredAddressOption(ITestOutputHelper output) : base(output) { }
    ...
    /// JIRA Task Link: https://lampstrack.lampsplus.com:8443/browse/ACD-5399
    /// Test Case Link: https://lampstrack.lampsplus.com:8443/secure/Tests.jspa#/testCase/LP-T415
    /// </summary>
    [Trait(LpTraits.Keys.Category, LpTraits.Suite.Mobile)]
    [Trait(LpTraits.RequiredTestCaseTags.TaskId, "ACD-5399"), Trait(LpTraits.RequiredTestCaseTags.TId, "LP-T415")]
    public abstract class T415_MobileBase : TestsBaseMobile
    {
        protected T415_MobileBase(ITestOutputHelper output) : base(output) { }
