...
namespace LampsPlus.RegressionTests.Common.Shipping.T7523_T7524_VerifyFedExModalShowsAptOptions
{
    ...
    public class T7524_iPhone_VerifyFedExModalShowsAptOptions : T7524_MobileBase
    {
        public T7524_iPhone_VerifyFedExModalShowsAptOptions(ITestOutputHelper output) : base(output) { }
    ...
    public class T7524_Emulator_VerifyFedExModalShowsAptOptions : T7524_MobileBase
    {
        public T7524_Emulator_VerifyFedExModalShowsAptOptions(ITestOutputHelper output) : base(output) { }
    ...
    /// Test Case Link: https://lampstrack.lampsplus.com:8443/secure/Tests.jspa#/testCase/LP-T7524
    /// </summary>
    [Trait(LpTraits.Keys.Category, LpTraits.Suite.Mobile)]
    [Trait(LpTraits.RequiredTestCaseTags.TaskId, "ACD-8686"), Trait(LpTraits.RequiredTestCaseTags.TId, "LP-T7524")]
    public abstract class T7524_MobileBase : TestsBaseMobile
    {
        protected T7524_MobileBase(ITestOutputHelper output) : base(output)
        {
        }
        ...
        protected void Validate(string config)
        {
            ...
            */
            ...
            Assert.Equals("We may need an Apartment/Suite Number for you.", CustomerAddressInformation.GetFedExModalElements["FedExAddressValidationHeader"].Text, "FedEx address validation header text is incorrect");
            Assert.Equals("ENTER APARTMENT/SUITE NUMBER", CustomerAddressInformation.GetFedExModalElements["DefaultAddressRadioElement"].Text, "ENTER APARTMENT/SUITE NUMBER option text is incorrect");
            Assert.Equals("MAINTAIN CURRENT ADDRESS", CustomerAddressInformation.GetFedExModalElements["NoChangeAddressRadioElement"].Text, "Maintain entered address option text is incorrect");
        ...
        {
            //Creating custom Address instance
            var addressCustom = new Address
            {
                FirstName = "Test - T7523",
                LastName = "Test - T7523",
                AddressLine1 = "1300 S Harding Dr",
                City = "Goldsboro",
                ZipCode = "27534"
            };
            ...
            CustomerAddressInformation.SelectState("NC");//North Carolina state selected
