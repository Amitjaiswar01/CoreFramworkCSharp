...
namespace LampsPlus.RegressionTests.Common.OrderHistory.T275_T486_VerifySignedOutUsersOnlySeePartialInfoOnTheOrderHistoryPage
{
    ...
    public class T275_Windows_VerifyUsersSeePartialInfoOrderHistory : T275_DesktopBase
    {
        public T275_Windows_VerifyUsersSeePartialInfoOrderHistory(ITestOutputHelper output) : base(output) { }
    ...
    //[Collection(LpTraits.BatchGroup.Common.OrderHistory)]
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.OrderHistory)]
    public class T275_Mac_VerifyUsersSeePartialInfoOrderHistory : T275_DesktopBase
    {
        public T275_Mac_VerifyUsersSeePartialInfoOrderHistory(ITestOutputHelper output) : base(output) { }
    ...
    //[Collection(LpTraits.BatchGroup.Common.OrderHistory)]
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.OrderHistory)]
    public class T275_iPad_VerifyUsersSeePartialInfoOrderHistory : T275_DesktopBase
    {
        public T275_iPad_VerifyUsersSeePartialInfoOrderHistory(ITestOutputHelper output) : base(output) { }
    ...
    //[Collection(LpTraits.BatchGroup.Common.OrderHistory)]
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.OrderHistory)]
    public class T275_TabletEmulator_VerifyUsersSeePartialInfoOrderHistory : T275_DesktopBase
    {
        public T275_TabletEmulator_VerifyUsersSeePartialInfoOrderHistory(ITestOutputHelper output) : base(output) { }
    ...
    /// JIRA Task Link: https://lampstrack.lampsplus.com:8443/browse/ACD-5106
    /// Test Case Link: https://lampstrack.lampsplus.com:8443/secure/Tests.jspa#/testCase/LP-T275
    /// </summary>
    //[Collection(LpTraits.BatchGroup.Common.OrderHistory)]
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.OrderHistory)]
    [Trait(LpTraits.Keys.Category, LpTraits.RunEnvironment.ProductionOnly)]
    [Trait(LpTraits.Keys.Category, LpTraits.Suite.Desktop)]
    [Trait(LpTraits.RequiredTestCaseTags.TaskId, "ACD-5106"), Trait(LpTraits.RequiredTestCaseTags.TId, "LP-T275")]

    public abstract class T275_DesktopBase : TestsBaseDesktop
    {
        protected T275_DesktopBase(ITestOutputHelper output) : base(output) { }
        ...
        private void VerifyOrderDetailsTable(List<OrderHistoryItems> orderHistoryItems)
        {
            ...
            {
                Assert.Equals(OrderDetails.GetDbProductName(orderDetailItem).Trim(), OrderDetails.GetProductName(orderDetailItem.ShortSku).Trim(), "Product Names do not match");
                Assert.Equals(OrderDetails.FormatPrice(orderDetailItem.UnitPrice).Trim(), OrderDetails.GetUnitPrice(orderDetailItem.ShortSku).Trim(), "Unit prices do not match");
                Assert.Equals(orderDetailItem.Quantity.ToString().Trim(), OrderDetails.GetProductQuantity(orderDetailItem.ShortSku).Trim(), "Quantities do not match");
                Assert.Equals(OrderDetails.GetStatusString(orderDetailItem).Trim(), OrderDetails.GetProductStatus(orderDetailItem.ShortSku).Trim(), "Item statuses do not match");
