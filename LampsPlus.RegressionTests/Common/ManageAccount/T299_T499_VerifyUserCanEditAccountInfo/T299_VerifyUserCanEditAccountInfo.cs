...
namespace LampsPlus.RegressionTests.Common.ManageAccount.T299_T499_VerifyUserCanEditAccountInfo
{
    ...
    public class T299_Windows_VerifyUserCanEditAndSaveAccountInfo : T299_DesktopBase
    {
        public T299_Windows_VerifyUserCanEditAndSaveAccountInfo(ITestOutputHelper output) : base(output) { }
    ...
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.ManageAccount)]
    public class T299_Mac_VerifyUserCanEditAndSaveAccountInfo : T299_DesktopBase
    {
        public T299_Mac_VerifyUserCanEditAndSaveAccountInfo(ITestOutputHelper output) : base(output) { }
    ...
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.ManageAccount)]
    public class T299_iPad_VerifyUserCanEditAndSaveAccountInfo : T299_DesktopBase
    {
        public T299_iPad_VerifyUserCanEditAndSaveAccountInfo(ITestOutputHelper output) : base(output) { }
    ...
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.ManageAccount)]
    public class T299_TabletEmulator_VerifyUserCanEditAndSaveAccountInfo : T299_DesktopBase
    {
        public T299_TabletEmulator_VerifyUserCanEditAndSaveAccountInfo(ITestOutputHelper output) : base(output) { }
    ...
    /// Test Case Link: https://lampstrack.lampsplus.com:8443/secure/Tests.jspa#/testCase/LP-T299
    /// </summary>
    [Trait(LpTraits.Keys.Category, LpTraits.Suite.Desktop)]
    [Trait(LpTraits.RequiredTestCaseTags.TaskId, "ACD-9902"), Trait(LpTraits.RequiredTestCaseTags.TId, "LP-T299")]
    public abstract class T299_DesktopBase : TestsBaseDesktop
    {
        protected T299_DesktopBase(ITestOutputHelper output) : base(output) { }
