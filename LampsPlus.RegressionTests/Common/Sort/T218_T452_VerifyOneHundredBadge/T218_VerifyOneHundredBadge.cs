...
namespace LampsPlus.RegressionTests.Common.Sort.T218_T452_VerifyOneHundredBadge
{
    ...
    public class T218_Windows_VerifyOneHundredBadge : T218_DesktopBase
    {
        public T218_Windows_VerifyOneHundredBadge(ITestOutputHelper output) : base(output) { }
    ...
    //[Collection(LpTraits.BatchGroup.Common.Sort)]
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.Sort)]
    public class T218_Mac_VerifyOneHundredBadge : T218_DesktopBase
    {
        public T218_Mac_VerifyOneHundredBadge(ITestOutputHelper output) : base(output) { }
    ...
    //[Collection(LpTraits.BatchGroup.Common.Sort)]
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.Sort)]
    public class T218_iPad_VerifyOneHundredBadge : T218_DesktopBase
    {
        public T218_iPad_VerifyOneHundredBadge(ITestOutputHelper output) : base(output) { }
    ...
    //[Collection(LpTraits.BatchGroup.Common.Sort)]
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.Sort)]
    public class T218_TabletEmulator_VerifyOneHundredBadge : T218_DesktopBase
    {
        public T218_TabletEmulator_VerifyOneHundredBadge(ITestOutputHelper output) : base(output) { }
    ...
    /// Test Case Link: https://lampstrack.lampsplus.com:8443/secure/Tests.jspa#/testCase/LP-T218
    /// </summary>
    [Trait(LpTraits.Keys.Category, LpTraits.Suite.Desktop)]
    [Trait(LpTraits.RequiredTestCaseTags.TaskId, "ACD-10085"), Trait(LpTraits.RequiredTestCaseTags.TId, "LP-T218")]
    public abstract class T218_DesktopBase : TestsBaseDesktop
    {
        protected T218_DesktopBase(ITestOutputHelper output) : base(output) { }
        ...
        protected void Validate(string config)
        {
            ...
            //Act : Execute query using Sku from the Sort page
            var dbOneHundredPlusItem = ProductActions.GetOneHundredPlusItem(sku);

            //Assert : Verify SKU and callout match the values from the the database
