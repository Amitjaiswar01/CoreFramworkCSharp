...
namespace LampsPlus.RegressionTests.Common.Sort.T7765_T7766_VerifyTheUserCanSearchForOpenBoxItemsOnly.cs
{
    ...
    public class T7765_Windows_VerifyCanonicalOrderingOfSortFilterAttributes : T7765_DesktopBase
    {
        public T7765_Windows_VerifyCanonicalOrderingOfSortFilterAttributes(ITestOutputHelper output) : base(output) { }
    ...
    //[Collection(LpTraits.BatchGroup.Common.Sort)]
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.Sort)]
    public class T7765_Mac_VerifyCanonicalOrderingOfSortFilterAttributes : T7765_DesktopBase
    {
        public T7765_Mac_VerifyCanonicalOrderingOfSortFilterAttributes(ITestOutputHelper output) : base(output) { }
    ...
    //[Collection(LpTraits.BatchGroup.Common.Sort)]
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.Sort)]
    public class T7765_iPad_VerifyCanonicalOrderingOfSortFilterAttributes : T7765_DesktopBase
    {
        public T7765_iPad_VerifyCanonicalOrderingOfSortFilterAttributes(ITestOutputHelper output) : base(output) { }
    ...
    //[Collection(LpTraits.BatchGroup.Common.Sort)]
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.Sort)]
    public class T7765_TabletEmulator_VerifyCanonicalOrderingOfSortFilterAttributes : T7765_DesktopBase
    {
        public T7765_TabletEmulator_VerifyCanonicalOrderingOfSortFilterAttributes(ITestOutputHelper output) : base(output) { }
    ...
    public abstract class T7765_DesktopBase : TestsBaseDesktop
    {
        protected T7765_DesktopBase(ITestOutputHelper output) : base(output) { }

        protected void Validate(string config)
        {
            //Arrange : User is on the following page: https://www.lampsplus.com/products/openbox_view-open-box-items/
            ...
            */
            ...
            Assert.Equals(Sort.GetViewOpenBoxText(), Sort.GetBreadCrumbText(), "The breadcrumbs do not include 'View Open Box Items'.");

            //Act : Search Random categories
