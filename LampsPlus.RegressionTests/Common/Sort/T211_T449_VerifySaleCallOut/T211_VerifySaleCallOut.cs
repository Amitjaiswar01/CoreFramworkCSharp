...
namespace LampsPlus.RegressionTests.Common.Sort.T211_T449_VerifySaleCallOut
{
    ...
    public class T211_Windows_VerifySaleCallOut : T211_DesktopBase
    {
        public T211_Windows_VerifySaleCallOut(ITestOutputHelper output) : base(output) { }
    ...
    //[Collection(LpTraits.BatchGroup.Common.Sort)]
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.Sort)]
    public class T211_Mac_VerifySaleCallOut : T211_DesktopBase
    {
        public T211_Mac_VerifySaleCallOut(ITestOutputHelper output) : base(output) { }
    ...
    //[Collection(LpTraits.BatchGroup.Common.Sort)]
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.Sort)]
    public class T211_iPad_VerifySaleCallOut : T211_DesktopBase
    {
        public T211_iPad_VerifySaleCallOut(ITestOutputHelper output) : base(output) { }
    ...
    //[Collection(LpTraits.BatchGroup.Common.Sort)]
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.Sort)]
    public class T211_TabletEmulator_VerifySaleCallOut : T211_DesktopBase
    {
        public T211_TabletEmulator_VerifySaleCallOut(ITestOutputHelper output) : base(output) { }
    ...
    /// Test Case Link: https://lampstrack.lampsplus.com:8443/secure/Tests.jspa#/testCase/LP-T211
    /// </summary>
    [Trait(LpTraits.Keys.Category, LpTraits.Suite.Desktop)]
    [Trait(LpTraits.RequiredTestCaseTags.TaskId, "ACD-10088"), Trait(LpTraits.RequiredTestCaseTags.TId, "LP-T211")]
    public abstract class T211_DesktopBase : TestsBaseDesktop
    {
        protected T211_DesktopBase(ITestOutputHelper output) : base(output) { }
        ...
        protected void Validate(string config)
        {
            ...
            string sku = Sort.GetSkuWithCallout(Sort.GetSaleCallout());
            ...
            Assert.True(salePrice < retailPrice, $"Expected salePrice1Internet < retailPriceInternet but slePrice1Internet was {salePrice} and the retailPriceInternet was {retailPrice}");
            ...
            Assert.Equals("rgba(51, 51, 51, 1)", Sort.GetTextColor(), "Sale Price color is not red" );
        }
    }
}