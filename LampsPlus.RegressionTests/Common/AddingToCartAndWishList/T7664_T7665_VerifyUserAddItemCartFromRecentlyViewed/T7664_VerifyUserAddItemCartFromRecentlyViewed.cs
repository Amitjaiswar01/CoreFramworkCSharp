...
namespace LampsPlus.RegressionTests.Common.AddingToCartAndWishList.T7664_T7665_VerifyUserAddItemCartFromRecentlyViewed
{
    ...
    public class T7664_Windows_VerifyUserAddItemCartFromRecentlyViewed : T7664_DesktopBase
    {
        public T7664_Windows_VerifyUserAddItemCartFromRecentlyViewed(ITestOutputHelper output) : base(output) { }
    ...
    public class T7664_Mac_VerifyUserAddItemCartFromRecentlyViewed : T7664_DesktopBase
    {
        public T7664_Mac_VerifyUserAddItemCartFromRecentlyViewed(ITestOutputHelper output) : base(output) { }
    ...
    //[Collection(LpTraits.BatchGroup.Common.AddingToCartAndWishList)]
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Mobile.AddingToCartAndWishList)]
    public class T7664_iPad_VerifyUserAddItemCartFromRecentlyViewed : T7664_DesktopBase
    {
        public T7664_iPad_VerifyUserAddItemCartFromRecentlyViewed(ITestOutputHelper output) : base(output) { }
    ...
    //[Collection(LpTraits.BatchGroup.Common.AddingToCartAndWishList)]
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Mobile.AddingToCartAndWishList)]
    public class T7664_TabletEmulator_VerifyUserAddItemCartFromRecentlyViewed : T7664_DesktopBase
    {
        public T7664_TabletEmulator_VerifyUserAddItemCartFromRecentlyViewed(ITestOutputHelper output) : base(output) { }
    ...
    /// Test Case Link: https://lampstrack.lampsplus.com:8443/secure/Tests.jspa#/testCase/LP-T7664
    /// </summary>
    [Trait(LpTraits.Keys.Category, LpTraits.Suite.Desktop)]
    [Trait(LpTraits.RequiredTestCaseTags.TaskId, "ACD-10101"), Trait(LpTraits.RequiredTestCaseTags.TId, "LP-T7664")]
    public abstract class T7664_DesktopBase : TestsBaseDesktop
    {
        protected T7664_DesktopBase(ITestOutputHelper output) : base(output) { }
        ...
        protected virtual void Validate(string config)
        {
            ...
            Assert.Equals(certonaSku, cartProductSku, "Incorrect SKU is Added to cart");
        }
    }
}
