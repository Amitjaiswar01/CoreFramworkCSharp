...
namespace LampsPlus.RegressionTests.Common.AddingToCartAndWishList.T355_T7577_VerifyAddingItemsWithBuildFullSystemToWishList
{
    ...
    public class T7577_iPhone_VerifyAddingItemsWithBuildFullSystemToWishList : T7577_MobileBase
    {
        public T7577_iPhone_VerifyAddingItemsWithBuildFullSystemToWishList(ITestOutputHelper output) : base(output) { }
    ...
    public class T7577_Emulator_VerifyAddingItemsWithBuildFullSystemToWishList : T7577_MobileBase
    {
        public T7577_Emulator_VerifyAddingItemsWithBuildFullSystemToWishList(ITestOutputHelper output) : base(output) { }
    ...
    /// Test Case Link: https://lampstrack.lampsplus.com:8443/secure/Tests.jspa#/testCase/LP-T7577
    /// </summary>
    [Trait(LpTraits.Keys.Category, LpTraits.Suite.Mobile)]
    [Trait(LpTraits.RequiredTestCaseTags.TaskId, "ACD-10105"), Trait(LpTraits.RequiredTestCaseTags.TId, "LP-T7577")]
    public abstract class T7577_MobileBase : TestsBaseMobile
    {
        protected T7577_MobileBase(ITestOutputHelper output) : base(output) { }
