...
namespace LampsPlus.RegressionTests.Common.AddingToCartAndWishList.T352_T7576_VerifyAddingItemsWithBuildFullSystemToCart
{
    ...
    //[Collection(LpTraits.BatchGroup.Desktop.AddingToCartAndWishList)]
    public class T352_Windows_VerifyAddingBuildFullSysToCart : T352_DesktopBase
    {
        public T352_Windows_VerifyAddingBuildFullSysToCart(ITestOutputHelper output) : base(output) { }
    ...
    public class T352_Mac_VerifyAddingBuildFullSysToCart : T352_DesktopBase
    {
        public T352_Mac_VerifyAddingBuildFullSysToCart(ITestOutputHelper output) : base(output) { }
    ...
    //[Collection(LpTraits.BatchGroup.Common.AddingToCartAndWishList)]
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.AddingToCartAndWishList)]
    public class T352_iPad_VerifyAddingBuildFullSysToCart : T352_DesktopBase
    {
        public T352_iPad_VerifyAddingBuildFullSysToCart(ITestOutputHelper output) : base(output) { }
    ...
    /// JIRA Task Link: https://lampstrack.lampsplus.com:8443/browse/ACD-5075
    /// Test Case Link: https://lampstrack.lampsplus.com:8443/secure/Tests.jspa#/testCase/LP-T352
    /// </summary>
    [Trait(LpTraits.Keys.Category, LpTraits.Suite.Desktop)]
    [Trait(LpTraits.RequiredTestCaseTags.TaskId, "ACD-5075"), Trait(LpTraits.RequiredTestCaseTags.TId, "LP-T352")]
    public abstract class T352_DesktopBase : TestsBaseDesktop
    {
        protected T352_DesktopBase(ITestOutputHelper output) : base(output) { }
