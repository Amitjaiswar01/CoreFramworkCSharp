...
namespace LampsPlus.RegressionTests.Common.Payment.T7981_T7983_VerifyPayPalWidgetPricesBetween30To1350
{
    ...
    public class T7983_iPhone_VerifyPayPalWidgetPricesBetween30To1350 : T7983_MobileBase
    {
        public T7983_iPhone_VerifyPayPalWidgetPricesBetween30To1350(ITestOutputHelper output) : base(output) { }
    ...
    //[Collection(LpTraits.BatchGroup.Common.Payment)]
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.Payment)]
    public class T7983_Android_VerifyPayPalWidgetPricesBetween30To1350 : T7983_MobileBase
    {
        public T7983_Android_VerifyPayPalWidgetPricesBetween30To1350(ITestOutputHelper output) : base(output) { }
    ...
    //[Collection(LpTraits.BatchGroup.Common.Payment)]
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.Payment)]
    public class T7983_Emulator_VerifyPayPalWidgetPricesBetween30To1350 : T7983_MobileBase
    {
        public T7983_Emulator_VerifyPayPalWidgetPricesBetween30To1350(ITestOutputHelper output) : base(output) { }
    ...
    /// Test Case Link: https://lampstrack.lampsplus.com:8443/secure/Tests.jspa#/testCase/LP-T7983
    /// </summary>
    [Trait(LpTraits.Keys.Category, LpTraits.Suite.Mobile)]
    [Trait(LpTraits.RequiredTestCaseTags.TaskId, "ACD-10807"), Trait(LpTraits.RequiredTestCaseTags.TId, "LP-T7983")]
    public abstract class T7983_MobileBase : TestsBaseMobile
    {
        protected T7983_MobileBase(ITestOutputHelper output) : base(output) { }
        ...
        private void PayPalVerbiageCondition(decimal productPricesPdp, string paypalCallOut)
        {
            ...
            {
                Assert.True(paypalCallOut.Contains("\r\n") ? paypalCallOut.Replace("\r\n", string.Empty).Equals($"As low as ${decimal.Parse(TextActions.GetPriceTextOnly(paypalCallOut))}/mo. with PayPal. Learn more") : paypalCallOut.Equals($"As low as ${decimal.Parse(TextActions.GetPriceTextOnly(paypalCallOut))}/mo. with PayPal. Learn more"), "PayPal Verbiage does not match for value in between $30 And $1350");
            }
        }
    }
}