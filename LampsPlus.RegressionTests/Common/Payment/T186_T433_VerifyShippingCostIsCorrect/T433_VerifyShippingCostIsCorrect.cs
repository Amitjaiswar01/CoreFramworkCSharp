...
namespace LampsPlus.RegressionTests.Common.Payment.T186_T433_VerifyShippingCostIsCorrect
{
    ...
    public class T433_iPhone_VerifyShippingCostIsCorrect : T433_MobileBase
    {
        public T433_iPhone_VerifyShippingCostIsCorrect(ITestOutputHelper output) : base(output) { }
    ...
    public class T433_Emulator_VerifyShippingCostIsCorrect : T433_MobileBase
    {
        public T433_Emulator_VerifyShippingCostIsCorrect(ITestOutputHelper output) : base(output) { }
    ...
    /// Test Case Link: https://lampstrack.lampsplus.com:8443/secure/Tests.jspa#/testCase/LP-T433
    /// </summary>
    [Trait(LpTraits.Keys.Category, LpTraits.Suite.Mobile)]
    [Trait(LpTraits.RequiredTestCaseTags.TaskId, "ACD-10001"), Trait(LpTraits.RequiredTestCaseTags.TId, "LP-T433")]
    public abstract class T433_MobileBase : TestsBaseMobile
    {
        protected T433_MobileBase(ITestOutputHelper output) : base(output) { }
