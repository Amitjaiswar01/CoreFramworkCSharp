...
namespace LampsPlus.RegressionTests.Common.Search.T7823_T7824_VerifySearchResultSetCanFilteredUsingSearchTermInSearchBarFilter
{
    ...
    public class T7824_iPhone_VerifySearchResultSetCanFilteredUsingSearchTermInSearchBarFilter : T7824_MobileBase
    {
        public T7824_iPhone_VerifySearchResultSetCanFilteredUsingSearchTermInSearchBarFilter(ITestOutputHelper output) : base(output) { }
    ...
    public class T7824_Emulator_VerifySearchResultSetCanFilteredUsingSearchTermInSearchBarFilter : T7824_MobileBase
    {
        public T7824_Emulator_VerifySearchResultSetCanFilteredUsingSearchTermInSearchBarFilter(ITestOutputHelper output) : base(output) { }
    ...
    //[Collection(LpTraits.BatchGroup.Common.Search)]
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Mobile.Search)]
    public class T7824_AndroidPhone_VerifySearchResultSetCanFilteredUsingSearchTermInSearchBarFilter : T7824_MobileBase
    {
        public T7824_AndroidPhone_VerifySearchResultSetCanFilteredUsingSearchTermInSearchBarFilter(ITestOutputHelper output) : base(output) { }
    ...
    /// Test Case Link: https://lampstrack.lampsplus.com:8443/secure/Tests.jspa#/testCase/LP-T7824
    /// </summary>
    [Trait(LpTraits.Keys.Category, LpTraits.Suite.Mobile)]
    [Trait(LpTraits.RequiredTestCaseTags.TaskId, "ACD-10927"), Trait(LpTraits.RequiredTestCaseTags.TId, "LP-T7824")]
    public abstract class T7824_MobileBase : TestsBaseMobile
    {
        protected T7824_MobileBase(ITestOutputHelper output) : base(output) { }
        ...
        protected void Validate(string config)
        {
            ...
            Browser.ScrollIntoView(Sort.GetContextualSearchBarForSort(), true);
