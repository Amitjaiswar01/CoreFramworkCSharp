...
namespace LampsPlus.RegressionTests.Common.OrderConfirmation.T7525_T7526_VerifyMinimalAccountOrder
{
    ...
    public class T7525_Windows_VerifyMinimalAccountOrder : T7525_DesktopBase
    {
        public T7525_Windows_VerifyMinimalAccountOrder(ITestOutputHelper output) : base(output) { }
    ...
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.OrderConfirmation)]
    public class T7525_Mac_VerifyMinimalAccountOrder : T137_DesktopBase
    {
        public T7525_Mac_VerifyMinimalAccountOrder(ITestOutputHelper output) : base(output) { }
    ...
    //[Collection(LpTraits.BatchGroup.Common.OrderConfirmation)]
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.OrderConfirmation)]
    public class T7525_iPad_VerifyMinimalAccountOrder : T137_DesktopBase
    {
        public T7525_iPad_VerifyMinimalAccountOrder(ITestOutputHelper output) : base(output) { }
    ...
    //[Collection(LpTraits.BatchGroup.Common.OrderConfirmation)]
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.OrderConfirmation)]
    public class T7525_TabletEmulator_VerifyMinimalAccountOrder : T137_DesktopBase
    {
        public T7525_TabletEmulator_VerifyMinimalAccountOrder(ITestOutputHelper output) : base(output) { }
    ...
    /// Test Case Link: https://lampstrack.lampsplus.com:8443/secure/Tests.jspa#/testCase/LP-T7525
    /// </summary>
    [Trait(LpTraits.Keys.Category, LpTraits.Suite.Desktop)]
    [Trait(LpTraits.RequiredTestCaseTags.TaskId, "ACD-8570"), Trait(LpTraits.RequiredTestCaseTags.TId, "LP-T7525")]
    public abstract class T7525_DesktopBase : TestsBaseDesktop
    {
        protected T7525_DesktopBase(ITestOutputHelper output) : base(output) { }
