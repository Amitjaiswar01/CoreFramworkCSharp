...
namespace LampsPlus.RegressionTests.Common.OtherPages.T7997_T7998_VerifyAddToCartFunctionalityOnSfpPage
{
    ...
    public class T7998_iPhone_VerifyAddToCartFunctionalityOnSfpPage : T7998_MobileBase
    {
        public T7998_iPhone_VerifyAddToCartFunctionalityOnSfpPage(ITestOutputHelper output) : base(output) { }
    ...
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.OtherPages)]
    public class T7998_Android_VerifyAddToCartFunctionalityOnSfpPage : T7998_MobileBase
    {
        public T7998_Android_VerifyAddToCartFunctionalityOnSfpPage(ITestOutputHelper output) : base(output) { }
    ...
    [Trait(LpTraits.Keys.Category, LpTraits.BatchGroup.Common.OtherPages)]
    public class T7998_Emulator_VerifyAddToCartFunctionalityOnSfpPage : T7998_MobileBase
    {
        public T7998_Emulator_VerifyAddToCartFunctionalityOnSfpPage(ITestOutputHelper output) : base(output) { }
    ...
    /// Test Case Link: https://lampstrack.lampsplus.com:8443/secure/Tests.jspa#/testCase/LP-T7998
    /// </summary>
    [Trait(LpTraits.Keys.Category, LpTraits.Suite.Mobile)]
    [Trait(LpTraits.RequiredTestCaseTags.TaskId, "ACD-10905"), Trait(LpTraits.RequiredTestCaseTags.TId, "LP-T7998")]
    public abstract class T7998_MobileBase : TestsBaseMobile
    {
        protected T7998_MobileBase(ITestOutputHelper output) : base(output) { }
