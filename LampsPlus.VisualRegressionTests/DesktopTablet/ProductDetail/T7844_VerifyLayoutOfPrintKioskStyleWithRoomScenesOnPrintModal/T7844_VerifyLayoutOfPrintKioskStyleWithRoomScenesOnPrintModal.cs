...
namespace LampsPlus.VisualRegressionTests.DesktopTablet.ProductDetail.T7844_VerifyLayoutOfPrintKioskStyleWithRoomScenesOnPrintModal
{
    ...
    public abstract class T7844_DesktopBase : VisualTestsBaseDesktop, IClassFixture<T7844_SharedProductSku_Fixture>
    {
        ...
        protected virtual void Validate(string config)
        {
            ...
            */
            ...
            Assert.True(Modal.IsModalVisible(), "Modal window is not visible.");
