...
set traits=-trait "Category=Android 8 Phone"
...
set resultsFileName=%projectDirectory%Results\%currentDate% %currentTime% %releaseName% Mobile Regression Android Phone Results
