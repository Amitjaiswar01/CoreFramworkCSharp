...
set traits=-trait "Category=iOS 12 Phone"
...
set resultsFileName=%projectDirectory%Results\%currentDate% %currentTime% %releaseName% Mobile Regression iPhone Results
