...
set traits=-trait "Category=iOS 12 Tablet"
...
set resultsFileName=%projectDirectory%Results\%currentDate% %currentTime% %releaseName% Desktop Regression iPad Results
