...
set traits=-trait "Category=Windows 10"
...
set resultsFileName=%projectDirectory%Results\%currentDate% %currentTime% %releaseName% Desktop Regression Window Results
