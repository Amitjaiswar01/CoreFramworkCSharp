...
{
    public class GoogleAnalyticsWorkflowMobile : IGoogleAnalyticsWorkflowMobile
    {
        //Class members
        ...
        public GoogleAnalyticsWorkflowMobile(IBrowser browser, Log log, ISortMobile sort, NetworkLoggingUtility networkLoggingUtility, IAssert assert, IProductDetailMobile productDetail, ICartMobile cart)
        {
            _browser = browser;
            _log = log;
            _sort = sort;
