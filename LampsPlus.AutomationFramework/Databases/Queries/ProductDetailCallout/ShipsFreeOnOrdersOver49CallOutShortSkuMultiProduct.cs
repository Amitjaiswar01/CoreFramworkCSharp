...
{
    /// <summary>
    /// Query to identify a multiproduct SKU that qualifies for the "Ships Free With Orders Over $49" callout. The SKU must be in a certain category and the retailprice less than
    ...
    /// </summary>
    public class ShipsFreeOnOrdersOver49CallOutShortSkuMultiProduct
    {
